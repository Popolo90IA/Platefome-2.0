...
export default function DesignPage() {
  ...
  return (
    <div className="animate-fade-up" style={{ display: "grid", gridTemplateColumns: "380px 1fr", gap: 20, height: "calc(100vh - 80px)", alignItems: "stretch", direction: "ltr", margin: "0 -32px" }}>
